...
public class MainActivity extends AppCompatActivity {
        ...
        booksApiCall.enqueue(new Callback<BookContainer>() {
            ...
            public void onFailure(Call<BookContainer> call, Throwable t) {
                Snackbar.make(findViewById(R.id.main_view),
                        getString(R.string.book_download_went_wrong),
    ...
    private class BookHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            intent.putExtra(BookDetailsActivity.EXTRA_BOOK_ACTIVITY_DETAILS_TITLE, bookTitleTextView.getText());
            intent.putExtra(BookDetailsActivity.EXTRA_BOOK_ACTIVITY_DETAILS_AUTHOR, bookAuthorTextView.getText());
            intent.putExtra(BookDetailsActivity.EXTRA_BOOK_ACTIVITY_DETAILS_PAGE_NUMBER, numberOfPagesTextView.getText());
            intent.putExtra(BookDetailsActivity.EXTRA_BOOK_ACTIVITY_DETAILS_COVER_ADDRESS, IMAGE_URL_BASE+book.getCover()+"-L.jpg");
            intent.putExtra(BookDetailsActivity.EXTRA_BOOK_ACTIVITY_DETAILS_EBOOK_ACCESS, book.getEbookAccess());
